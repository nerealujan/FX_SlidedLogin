...
//	private ResourceBundle resources;
	...
	public void initialize() {
		...
		pane1.setStyle("-fx-background-image: url('application/camino-arbolado.jpg')");
		pane2.setStyle("-fx-background-image: url('application/pane2.jpg')");
		pane3.setStyle("-fx-background-image: url('application/pane3.jpg')");
		pane4.setStyle("-fx-background-image: url('application/pane4.jpg')");
